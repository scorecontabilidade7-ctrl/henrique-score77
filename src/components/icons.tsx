// Minimal inline icon set (stroke-based, 24x24) so we ship no icon dependency.
...
export const IconKanban = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <rect x="9.5" y="3" width="6" height="9" rx="1" transform="translate(0.5 0)" />
    <path d="M4 3v0" />
...
export const IconEquipe = (p: IconProps) => (
  <svg {...base(p)}>
...
export const IconProjetos = (p: IconProps) => (
  <svg {...base(p)}>
...
export const IconRelogio = (p: IconProps) => (
  <svg {...base(p)}>
