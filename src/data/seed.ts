...
export const dadosIniciais: DadosApp = {
  ...
  tarefas: [
    ...
    { id: 't1', titulo: 'Briefing e recolhimento de arquivos', descricao: 'Coletar documentos contábeis dos últimos 3 meses.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e1', responsaveisIds: ['m1'], tipo: 'consultoria', prioridade: 'urgente', status: 'concluido', prazo: isoRelativo(-24), estimativaHoras: 8, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't2', titulo: 'Diagnóstico empresarial', descricao: 'Levantar situação financeira e gargalos.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e1', responsaveisIds: ['m2', 'm1'], tipo: 'consultoria', prioridade: 'alta', status: 'concluido', prazo: isoRelativo(-17), estimativaHoras: 12, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't3', titulo: 'Análise SWOT e Matriz GUT', descricao: 'Priorizar problemas por Gravidade, Urgência e Tendência.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e1', responsaveisIds: ['m1', 'm5'], tipo: 'consultoria', prioridade: 'alta', status: 'em_revisao', prazo: isoRelativo(-1), estimativaHoras: 10, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't4', titulo: 'Criação do plano de contas', descricao: 'Estruturar o plano de contas da empresa.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e2', responsaveisIds: ['m3'], tipo: 'consultoria', prioridade: 'alta', status: 'em_andamento', prazo: isoRelativo(3), estimativaHoras: 16, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't5', titulo: 'Mapeamento do processo financeiro', descricao: 'Desenhar as rotinas financeiras atuais.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e2', responsaveisIds: ['m2'], tipo: 'consultoria', prioridade: 'media', status: 'a_fazer', prazo: isoRelativo(6), estimativaHoras: 14, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't6', titulo: 'Fluxo de caixa (desenho do processo)', descricao: 'Implantar controle diário de caixa.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e3', responsaveisIds: ['m2', 'm5'], tipo: 'consultoria', prioridade: 'urgente', status: 'a_fazer', prazo: isoRelativo(9), estimativaHoras: 20, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't7', titulo: 'Contas a pagar (treinamento)', descricao: 'Treinar equipe do cliente no processo de CP.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e3', responsaveisIds: ['m3'], tipo: 'consultoria', prioridade: 'media', status: 'a_fazer', prazo: isoRelativo(16), estimativaHoras: 8, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't8', titulo: 'DRE e DFC do trimestre', descricao: 'Montar demonstrações e curva ABC.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e4', responsaveisIds: ['m1'], tipo: 'consultoria', prioridade: 'media', status: 'a_fazer', prazo: isoRelativo(25), estimativaHoras: 12, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't9', titulo: 'Planejamento orçamentário 2027', descricao: 'Construir orçamento anual com o cliente.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e5', responsaveisIds: ['m1', 'm2'], tipo: 'consultoria', prioridade: 'baixa', status: 'a_fazer', prazo: isoRelativo(40), estimativaHoras: 18, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },

    // --- Projeto 2: Implantação de sistema contábil ---
    { id: 't10', titulo: 'Levantar volume de notas fiscais', descricao: 'Dimensionar a migração de dados.', clienteId: 'c2', projetoId: 'p2', etapaId: 'e6', responsaveisIds: ['m2'], tipo: 'consultoria', prioridade: 'media', status: 'em_andamento', prazo: isoRelativo(4), estimativaHoras: 6, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't11', titulo: 'Migração de dados contábeis', descricao: 'Importar histórico para o novo sistema.', clienteId: 'c2', projetoId: 'p2', etapaId: 'e7', responsaveisIds: ['m3', 'm2'], tipo: 'consultoria', prioridade: 'alta', status: 'a_fazer', prazo: isoRelativo(20), estimativaHoras: 24, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },

    // --- Tarefas contábeis avulsas / recorrentes ---
    { id: 't12', titulo: 'Apurar DAS - Simples Nacional', descricao: 'Emitir guia do Simples do mês.', clienteId: 'c1', projetoId: null, etapaId: null, responsaveisIds: ['m3'], tipo: 'contabil', prioridade: 'alta', status: 'a_fazer', prazo: isoRelativo(2), estimativaHoras: 2, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't13', titulo: 'Fechar folha de pagamento', descricao: 'Consolidar folha e enviar para aprovação.', clienteId: 'c6', projetoId: null, etapaId: null, responsaveisIds: ['m4'], tipo: 'contabil', prioridade: 'urgente', status: 'em_andamento', prazo: isoRelativo(1), estimativaHoras: 4, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 't14', titulo: 'Emitir guia INSS', descricao: 'Gerar guia da previdência.', clienteId: 'c4', projetoId: null, etapaId: null, responsaveisIds: ['m4'], tipo: 'contabil', prioridade: 'alta', status: 'a_fazer', prazo: isoRelativo(0), estimativaHoras: 1, data: null, horaInicio: null, horaFim: null, checklists: [], comentarios: [], tagsIds: [], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },

    // --- Reuniões agendadas (aparecem no Calendário; algumas com vários responsáveis) ---
    { id: 'r1', titulo: 'Alinhamento diário da consultoria', descricao: 'Daily do time de consultoria.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e2', responsaveisIds: ['m1', 'm2', 'm5'], tipo: 'reuniao', prioridade: 'media', status: 'a_fazer', prazo: isoRelativo(0), estimativaHoras: 0.5, data: isoRelativo(0), horaInicio: '09:00', horaFim: '09:30', checklists: [], comentarios: [], tagsIds: ['tag1'], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 'r2', titulo: 'Reunião de diagnóstico com o cliente', descricao: 'Apresentar SWOT e GUT à Construtora Alicerce.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e1', responsaveisIds: ['m1', 'm2'], tipo: 'reuniao', prioridade: 'alta', status: 'a_fazer', prazo: isoRelativo(0), estimativaHoras: 1, data: isoRelativo(0), horaInicio: '11:00', horaFim: '12:00', checklists: [], comentarios: [], tagsIds: ['tag1'], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 'r3', titulo: 'Treinamento de fluxo de caixa', descricao: 'Treinar equipe do cliente.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e3', responsaveisIds: ['m2'], tipo: 'reuniao', prioridade: 'media', status: 'a_fazer', prazo: isoRelativo(1), estimativaHoras: 2, data: isoRelativo(1), horaInicio: '14:00', horaFim: '16:00', checklists: [], comentarios: [], tagsIds: ['tag1'], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 'r4', titulo: 'Kickoff implantação TechNova', descricao: 'Alinhar cronograma e responsáveis.', clienteId: 'c2', projetoId: 'p2', etapaId: 'e6', responsaveisIds: ['m2', 'm3'], tipo: 'reuniao', prioridade: 'alta', status: 'a_fazer', prazo: isoRelativo(2), estimativaHoras: 1.5, data: isoRelativo(2), horaInicio: '10:00', horaFim: '11:30', checklists: [], comentarios: [], tagsIds: ['tag1'], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 'r5', titulo: 'Revisão semanal do projeto', descricao: 'Status geral com sócios.', clienteId: 'c3', projetoId: 'p1', etapaId: null, responsaveisIds: ['m1', 'm2', 'm3', 'm5'], tipo: 'reuniao', prioridade: 'media', status: 'a_fazer', prazo: isoRelativo(3), estimativaHoras: 1, data: isoRelativo(3), horaInicio: '16:00', horaFim: '17:00', checklists: [], comentarios: [], tagsIds: ['tag1'], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
    { id: 'r6', titulo: 'Reunião com contador do cliente', descricao: 'Dúvidas do plano de contas.', clienteId: 'c3', projetoId: 'p1', etapaId: 'e2', responsaveisIds: ['m3'], tipo: 'reuniao', prioridade: 'media', status: 'a_fazer', prazo: isoRelativo(-1), estimativaHoras: 1, data: isoRelativo(-1), horaInicio: '15:00', horaFim: '16:00', checklists: [], comentarios: [], tagsIds: ['tag1'], ata: { participantesEmpresa: '', resumo: '', deveresDeCasa: '', observacoes: '' }, gravacaoUrl: '', criadaEm: agora() },
